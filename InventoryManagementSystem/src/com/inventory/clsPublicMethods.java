...
public class clsPublicMethods {
	...
	public static JComboBox fillCombo(String strSQL,Connection sCon,String strFieldName){
		Statement stFC;
		ResultSet rsFC;
		String cmbList[] =new String[10];
		int TotalRow = 0;
		int rowNum = 0;
		try{
			stFC = sCon.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
